    ...
    <div id="header_componant">
      <div id="searchContainer">
        ...
        <Button
          ...
          filterSearchValue={handleChangeSearch}
        />
      </div>
      <div id="filterCountry">
        ...
        >
          <option className="region_filter" value="all">
            All continents
          </option>
          <option className="region_filter" value="Africa">
            Africa
          </option>
          <option className="region_filter" value="Americas">
            America
          </option>
          <option className="region_filter" value="Asia">
            Asia
          </option>
          <option className="region_filter" value="Europe">
            Europa
          </option>
          <option className="region_filter" value="Oceania">
            Oceania
          </option>
        </select>
      </div>
